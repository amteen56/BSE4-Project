...
function CheckForWinner() {
    if (pawnOut[currcolor] == 4) {
        ...
        <%#Practice.Game.Winner(currcolor)%> ;
...
function ResetPawn(victim) {
    ...
    switch (victim) {
        case "redpawn1": pawnToMove.style.top = 200 + "px"; pawnToMove.style.left = 557 + "px"; break;
        case "redpawn2": pawnToMove.style.top = 153 + "px"; pawnToMove.style.left = 510 + "px"; break;
        case "redpawn3": pawnToMove.style.top = 107 + "px"; pawnToMove.style.left = 557 + "px"; break;
        case "redpawn4": pawnToMove.style.top = 153 + "px"; pawnToMove.style.left = 605 + "px"; break;
        case "bluepawn1": pawnToMove.style.top = 550 + "px"; pawnToMove.style.left = 557 + "px"; break;
        case "bluepawn2": pawnToMove.style.top = 503 + "px"; pawnToMove.style.left = 510 + "px"; break;
        case "bluepawn3": pawnToMove.style.top = 456 + "px"; pawnToMove.style.left = 557 + "px"; break;
        case "bluepawn4": pawnToMove.style.top = 503 + "px"; pawnToMove.style.left = 605 + "px"; break;
        case "greenpawn1": pawnToMove.style.top = 200 + "px"; pawnToMove.style.left = 208 + "px"; break;
        case "greenpawn2": pawnToMove.style.top = 153 + "px"; pawnToMove.style.left = 255 + "px"; break;
        case "greenpawn3": pawnToMove.style.top = 107 + "px"; pawnToMove.style.left = 208 + "px"; break;
        case "greenpawn4": pawnToMove.style.top = 153 + "px"; pawnToMove.style.left = 161 + "px"; break;
        case "yellowpawn1": pawnToMove.style.top = 503 + "px"; pawnToMove.style.left = 161 + "px"; break;
        case "yellowpawn2": pawnToMove.style.top = 503 + "px"; pawnToMove.style.left = 255 + "px"; break;
        case "yellowpawn3": pawnToMove.style.top = 456 + "px"; pawnToMove.style.left = 208 + "px"; break;
        case "yellowpawn4": pawnToMove.style.top = 550 + "px"; pawnToMove.style.left = 208 + "px"; break;
            ...
            if (text.innerText == currcolor) {
                if (onboard[currpawn] === 1 || num === 6) {
                    if (onboard[currpawn] === 0) {
                        ...
                        switch (Color) {
                            case "red":
                                doc.style.left = 433 + 'px';
                                doc.style.top = 80 + "px";
                                break;

                            case "yellow":
                                doc.style.left = 334 + 'px';
                                doc.style.top = 575 + "px";
                                break;

                            case "blue":
                                doc.style.left = 631 + 'px';
                                doc.style.top = 377 + "px";
                                break;

                            case "green":
                                doc.style.left = 136 + 'px';
                                doc.style.top = 278 + "px";
                                break;
                        }
                        onboard[currpawn] = 1;
                    }
